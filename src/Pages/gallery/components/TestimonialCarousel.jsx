...
const TestimonialCarousel = () => {
  ...
  return (
    <section className="bg-[#081426] py-12">
      <div className="container mx-auto px-6">
        ...
        <div className="bg-[#0d1a2f] border border-white/10 rounded-2xl p-8 mb-12 shadow-neutral">
          <div className="relative">
                ...
                <div className="flex items-center justify-center lg:justify-start space-x-1 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <Icon
                      ...
                      name="Star"
                      size={20}
                      className={i < currentTestimonial?.rating ? 'text-yellow-400' : 'text-white/30'}
                    />
                  ))}
                </div>
            ...
            <div className="flex items-center justify-center mt-8 space-x-4">
              <button
                onClick={handlePrev}
                className="w-12 h-12 bg-white/10 border border-white/20 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors duration-200"
              ...
              <div className="flex space-x-2">
                {testimonials?.map((_, index) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-colors duration-200 ${index === currentIndex ? 'bg-brand-energy' : 'bg-white/40'}`}
