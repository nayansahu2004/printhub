  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: `The Print Hub exceeded our expectations for our company's annual event. The custom t-shirts were delivered on time with exceptional quality. Satya's attention to detail and customer service is outstanding. We've already placed our next order!`,
    ...
    },
    {
      ...
      rating: 5,
      text: `The promotional mugs and keychains for my electronics store were perfect! Great quality at competitive prices. The WhatsApp ordering process made everything so convenient. Highly recommend The Print Hub for any business promotional needs.`,
    ...
    },
    {
      ...
      rating: 5,
      text: `Our cricket team jerseys came out amazing! The fabric quality is excellent and the printing hasn't faded even after multiple washes. The Print Hub understood our requirements perfectly and delivered exactly what we wanted.`,
    ...
    },
    {
      ...
      rating: 5,
      text: `As a content creator, I needed unique merchandise for my followers. The Print Hub helped me create custom phone cases and mugs with my brand design. The quality is top-notch and my audience loves them! Fast delivery too.`,
  ...
  return (
    <section className="py-16 bg-[#081426]">
      <div className="container-brand">
        ...
        {/* Section Header — TEXT UNCHANGED, ONLY STYLE UPDATED */}
        <div className="text-center mb-12">
          <div className="flex items-center justify-center space-x-2 text-white mb-4">
            <Icon name="Star" size={24} className="text-yellow-400" />
            <span className="text-sm font-medium uppercase tracking-wider text-white">Customer Stories</span>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#0d1a2f] rounded-2xl p-8 lg:p-12 shadow-neutral-lg">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4 border-t border-white/20">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-white/70">{currentTestimonial?.service}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Icon name="Hash" size={16} className="text-brand-energy" />
                    <span className="text-sm text-white/70">{currentTestimonial?.orderSize}</span>
                  </div>
                </div>
              ...
              <div className="relative">
                ...
                <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-lg p-2 shadow-neutral">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-xs font-medium text-[#081426]">Quality Work</span>
                  </div>
                </div>
              </div>
          ...
          <div className="flex items-center justify-center space-x-4 mt-8">
            <button
              ...
              className="w-12 h-12 bg-white/10 border border-white/30 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors duration-200"
            >
